...
<?php
	...
	while($row = mpress_fetch_array($resultado)){
		...
		//$dados[colunas][conteudo][$i][$c++] = "<p Style='margin:2px 3px 0 3px;float:center;'><a href='#' class='link workflow-localiza' id='cadastro-localiza-".$row[Workflow_ID]."' name='".$row[Workflow_ID]."'><p Style='margin:2px 5px 0 5px;float:left;'>visualizar</p><a></p>";
	}
	$largura = "100%";
	$colunas = $c-1;
	$c = 1;
