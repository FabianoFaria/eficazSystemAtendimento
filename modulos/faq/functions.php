		...
		<div class='conteudo-interno'>
			<div class='titulo-secundario uma-coluna' Style='margin-top:5px;'>
				<div class="titulo-secundario" style='float:left; width:70%'>
					...
					<p><textarea id="resposta-descricao" name="resposta-descricao" class='resposta-descricao' style='width:99%;height:120px'><?php echo utf8_encode($descricaoResposta); ?></textarea></p>
				</div>
