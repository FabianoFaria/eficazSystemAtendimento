<?php
	...
	function VerificaErro($vmPost, $vmResposta)
	{
		...
		try
		{
			...
			{
				throw new Exception("CERTIFICADO INVÁLIDO - O certificado da transa&ccedil;&atilde;o n&atilde;o foi aprovado", "099");
			}
		...
		catch (Exception $ex)
		{
			...
			// Gera página HTML
			echo '<html><head><title>Erro yyy na transa&ccedil;&atilde;o</title></head><body>';
