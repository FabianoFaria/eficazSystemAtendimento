...
if($_POST){
	$_SESSION['CIELO'] 		 = $_POST['loja'];
	$_SESSION['CIELO_CHAVE'] = $_POST['chave'];
}
define("CIELO", $_SESSION['CIELO']);
define("CIELO_CHAVE", $_SESSION['CIELO_CHAVE']);
...
function httprequest($paEndereco, $paPost){
	...
	curl_setopt($sessao_curl, CURLOPT_CAINFO, getcwd()."/ssl/VeriSign.crt");
	...
	$erroRetorno = curl_error($sessao_curl);
