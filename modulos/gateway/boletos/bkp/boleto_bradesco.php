...
$dadosboleto["nosso_numero"] = "10$idPedido";  // Nosso numero sem o DV - REGRA: Máximo de 11 caracteres!
...
$posAgencia = strpos($configuracaoBoleto[agencia], "-");
$posCC = strpos($configuracaoBoleto[agencia], "-");

$dadosboleto["agencia"] 	= substr($configuracaoBoleto[agencia], 0, $posAgencia); // Num da agencia, sem digito
$dadosboleto["agencia_dv"] 	= substr($configuracaoBoleto[agencia], $posAgencia+1, 10); // Digito do Num da agencia
...
$dadosboleto["conta_cedente"] 	 = $configuracaoBoleto[conta]; // ContaCedente do Cliente, sem digito (Somente Números)
