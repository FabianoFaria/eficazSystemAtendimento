...
$dadosboleto["convenio"] = $configuracaoBoleto['conveniocobranca'];  // Num do convênio - REGRA: 6 ou 7 ou 8 dígitos
$dadosboleto["contrato"] = $configuracaoBoleto[comercioeletronico]; // Num do seu contrato
