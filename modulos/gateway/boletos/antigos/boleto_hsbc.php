...
$codigoCedente = $dadosboleto["agencia"].$dadosboleto["conta"].$dadosboleto["conta_dv"];

$dadosboleto["codigo_cedente"] = $codigoCedente; // Código do Cedente (Somente 7 digitos)
...
<IMG src="imagens/logohsbc.jpg" width="150" height="40" border=0>
</div>
