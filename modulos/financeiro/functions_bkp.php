			...
			if (($modulosAtivos[nfe])&&($contaID!="")&&($empresaID!="")){
				...
				echo "	<div class='titulo-container conjunto5'>
							...
							<div class='conteudo-interno'>
								...
								<div class='titulo-secundario' style='float:left;width:40%;' class='obrigatorio'>
									<p><b>Destino Opera&ccedil;&atilde;o:</b><p>
									<p>
										<select name='dados[idDest]' id='idDest' class='obrigatorio'>
											<option value='1' ".$selFrete[1].">1 - Opera&ccedil;&atilde;o interna</option>
											<option value='2' ".$selFrete[2].">2 - Opera&ccedil;&atilde;o interestadual</option>
											<option value='3' ".$selFrete[2].">3 - Opera&ccedil;&atilde;o com exterior</option>
										</select>
									</p>
								</div>";
